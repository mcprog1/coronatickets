...
public class SeleccionarFuncionCU8 extends javax.swing.JFrame {

    private IControladorFuncion ICF;

    public SeleccionarFuncionCU8() {
        initComponents();
        ICF = Fabrica.getInstance().getIControladorFuncion();
        try {
            CargarDatos();
        } catch (SQLException ex) {
            Logger.getLogger(SeleccionarFuncionCU8.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSiguienteMouseClicked
         if (tblFunciones.getSelectedRow() >= 0) {
            RegistrarEspectadorFuncionCU8 newframe = new RegistrarEspectadorFuncionCU8();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarFuncionCU8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarFuncionCU8().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tblFunciones;
    ...
    private void CargarDatos() throws SQLException, ClassNotFoundException, IOException {
        ...
        lista = ICF.ListarFuncionesEspectaculo(SeleccionarEspectaculoCU8.lstEspetaculo.getSelectedValue());

        DefaultTableModel model = (DefaultTableModel) tblFunciones.getModel();

        model.setRowCount(0);

        for (Funciones f : lista) {
            
            Timestamp hora = f.getHoraDeInicio();
            SimpleDateFormat sdf = new SimpleDateFormat("hh:mm");
            
            Object[] fila = {f.getNombre(), f.getFecha(), sdf.format(hora)};
            model.addRow(fila);
        }
    }
}
